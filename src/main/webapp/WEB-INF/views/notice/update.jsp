		...
		<div class="row ">
			...
			<div class="mb-3">
				...
				<div class="mb-3">
					...
					<textarea class="form-control" id="board_contents" name="board_contents">${dto.board_contents}</textarea>
				</div>
					<div class="mb-3">
					<input type="hidden" class="form-control" id="board_category" name="board_category" value="${dto.board_category}">
				</div>
